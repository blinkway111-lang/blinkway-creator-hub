...
function CategoryCard({
  ...
  return <Link to={`/categories?filter=${category.id}`} className="group relative bg-card rounded-2xl p-6 border border-border hover:border-accent/30 shadow-card hover:shadow-lg transition-all duration-300">
