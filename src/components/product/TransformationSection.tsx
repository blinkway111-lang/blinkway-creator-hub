...
export function TransformationSection({
  transformations = [{
    before: "Scattered efforts with no direction",
    after: "Clear, actionable roadmap to success"
  }, {
    before: "Hours wasted on trial and error",
    after: "Proven strategies that work immediately"
  }, {
    before: "Feeling stuck and overwhelmed",
    after: "Confident and in control of your growth"
  }],
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            {/* Before Column */}
            <div className="rounded-2xl p-6 md:p-8 bg-primary-foreground">
              <div className="text-sm uppercase tracking-wider text-muted-foreground font-semibold mb-6">
                Before
              </div>
              <div className="space-y-4">
                {transformations.map((item, index) => <div key={index} className="flex items-start gap-3">
          ...
          {/* CTA */}
          {onCtaClick && <div className="text-center">
              <Button variant="hero" size="lg" onClick={onCtaClick} disabled={isLoading}>
