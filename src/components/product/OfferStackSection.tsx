      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-card rounded-2xl border border-border overflow-hidden mb-8">
            {displayOffers.map((offer, index) => <div key={index} className={`flex items-start gap-4 p-6 ${index !== displayOffers.length - 1 ? 'border-b border-border' : ''}`}>
          ...
          <div className="text-center">
            <div className="mb-6">
              ...
              <span className="text-muted-foreground ml-2 text-center">one-time</span>
            </div>
            
            <Button variant="hero" size="xl" onClick={onAddToCart} disabled={isLoading} className="w-full sm:w-auto">
